...
public class FT1850Loader extends AbstractLoader {
	...
	private static final String[] famcArrayM = { "Deres søn, arbejdsmand", "Deres søn, fraværende",
			"Deres søn, hjælper faderen", "Deres søn, skræder", "Deres søn, student", "Hans søn", "Hendes søn",
			"Hendes søn, skræderlærling", "Skræder, hendes søn" };
	private static final String[] famcArrayF = { "Deres datter", "Hans datter", "Hendes datter" };
	private static final String[] famcArray = { "Deres barn", "Hans barn", "Hendes barn", "Hendes uægte barn" };
