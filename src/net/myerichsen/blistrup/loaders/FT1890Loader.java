...
public class FT1890Loader extends AbstractLoader {
	...
	private static final String[] famcArrayM = { "Stedsøn", "Søn" };
	...
	private static final String SELECT1 = "SELECT * FROM FT1890";
	...
	public static void main(String[] args) {
		try {
			final int taeller = new FT1890Loader().load();
			System.out.println("Har indlæst " + taeller + " linier fra 1890 folketællingen");
	...
	private IndividData insertIndividual(Connection conn, ResultSet rs, int kildeId, int familieId)
		...
		try {
			iModel.setFoedt(Integer.toString(1890 - Integer.parseInt(rs.getString("ALDER"))));
	...
	private int load() throws SQLException {
		...
		final int kildeId = insertSource(conn, "1890");
