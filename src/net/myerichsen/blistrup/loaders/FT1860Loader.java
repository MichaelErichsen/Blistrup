...
public class FT1860Loader extends AbstractLoader {
	...
	private static final String[] famcArrayM = { "Deres Søn", "Hans Søn", "Hendes Stedsøn. Snedker", "Hendes Søn",
			"Hendes Søn. Daglejer", "Hendes Søn. Træskomand" };
	private static final String[] famcArrayF = { "Deres Datter", "Deres Datter. Væverpige", "Hans Datter",
			"Hendes Datter", "Hendes Datter. Sypige", "Hendes Datter. Væverske" };
	private static final String[] famcArray = { "Deres Barn", "Deres Barn. Skomager", "Deres Barn. Stenhugger",
			"Deres Barn. Sypige", "Deres Barn. Væverske", "Gaardejers Stedbarn", "Hans Barn", "Hans Barn. Skrædder",
			"Hendes Barn", "Hendes Barn. Daglejer", "Hendes Barn. Væverske", "Husfaders Stedbarn" };
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Har indlæst " + taeller + " linier fra 1860 folketællingen");
